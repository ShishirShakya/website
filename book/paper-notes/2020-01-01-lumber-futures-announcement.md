---
title: Announcement effects in US lumber futures market
short_title: Lumber futures announcements
date: '2020-01-01'
description: Lumber futures market announcements cause temporary price volatility spikes (3-5 days) with larger magnitude effects on more volatile contract months.
tags:
  - markets
  - commodity-futures
  - natural-resources
...
Commodity futures are used by producers, traders, and speculators to manage risk and profit from price movements. Understanding how news hits these markets matters for both. For mills and producers, the finding shows that announcements cause temporary price swings - hedging plans need to account for announcement-driven volatility spikes beyond normal market noise. For traders and speculators, it validates event-study strategy viability but also suggests that announcement effects are temporary and reversionary, meaning mean-reversion trading is possible. For market regulators and exchanges, the result indicates that announcement-driven volatility is real, potentially creating opportunities for manipulation or unfair information advantages if some market participants get early access. The contract-specific group differences (deferred months show larger swings) also suggests that information cascades differently across the futures curve, relevant for forward-looking price discovery and hedging horizon selection.

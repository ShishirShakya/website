---
title: Natural disasters and labor migration in Nepal
short_title: Nepal earthquake and migration
date: '2022-01-01'
description: 2015 Nepal earthquake increased international labor migration by 1.5 percentage points in severely affected districts.
tags:
...
2015 Nepal earthquake with 14 severely affected districts (National Reconstruction Authority classification) versus 61 unaffected control districts. International labor migration measured through work permits from Nepal's Department of International Employment (DoFE) for temporary contract workers. Data focuses on documented legal labor migration (approximately 85% of 2008-2015 international migration from Nepal to Gulf countries).
...
Earthquakes kill and destroy, but households also respond deliberately by migrating for work. This paper shows the effect is real and substantial - natural disasters increase international labor migration, likely as households seek income to rebuild. For disaster response policy, the finding suggests that post-earthquake employment creation is a priority (not just housing or medical care) - without local jobs, migration becomes the livelihood strategy. For labor-receiving countries, earthquake-driven migration spikes may be predictable and temporary. For Nepal specifically, remittances from earthquake-displaced workers represented needed income for affected households. The work complicates the narrative of "disaster-induced forced displacement" - many moves are not permanent relocations but temporary labor migration for reconstruction resources. This has consequences for humanitarian policy: supporting in-place recovery may be more cost-effective than managing displacement when temporary migration for income is the household response.
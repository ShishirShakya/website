---
title: Hospital ownership changes and charge-to-cost shifts
short_title: Hospital ownership and charges
date: '2024-01-01'
description: Hospital transitions to for-profit ownership increase charge-to-cost ratios by 161% versus governmental and 99.7% versus non-profit hospitals.
tags:
  - healthcare
  - institutional
  - hospital-pricing
  - ownership
publication_id: beniwal-2024-hospital-ownership-charge-cost
status: verified
---

# Hospital ownership changes and charge-to-cost shifts

Explainer of Beniwal et al. (2024), *Economics Letters*. Not the journal article.

**Citation**: Beniwal, S., & Shakya, S. (2024). Hospital ownership changes and charge-to-cost shifts. *Economics Letters*. [Free PDF](https://www.dropbox.com/scl/fi/nob6hng0eydoob8ja7d1h/HospitalOwnershipChangeAndCostAnalysis.pdf?rlkey=2qaufyd6evfcatbbtmcwxnex8&dl=0)
...
Higher CCR does not necessarily translate to higher profits or improved patient results. CCR complexity includes uncompensated care, payer mix, charity contributions, and cost accounting practices. Pre-ownership-change trends in for-profit CCR temper causal interpretation; for-profit CCR increases may partially reflect mean reversion or selection of hospitals that were already moving toward for-profit status. Dataset has limitations such as lack of cost segregation between inpatient and outpatient, reliance on hospitals' administrative records, and variations in cost structures across facilities.

...
def generate_category_file(category: str, publications: List[str], output_path: Path):
    ...
    descriptions = {
        'healthcare': 'Journal Publications on healthcare labor, licensing, and provider regulation.',
        'sud': 'Journal Publications on substance use disorder, opioids, and related policy.',
        'institutional': 'Journal Publications on institutions, revolutions, and political economy.',
        'education': 'Journal Publications on economics education, assessment, and replicability.',
        'veterans_health': 'Journal Publications related to veterans health and military-connected licensing.',
        'strategic_analysis': 'Journal Publications related to conflict, revolutions, and political economy.',
    }

    t = titles[category]
    d = descriptions[category]
